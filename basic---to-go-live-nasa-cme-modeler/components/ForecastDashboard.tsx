...
import { ACE_EPAM_URL, CAMERAS, ForecastCamera, GAUGE_COLORS, formatTimeHHMM, getAuroraEmoji, getForecastScoreColorKey, getGaugeStyle, getLatestPointTime, getSuggestedCameraSettings, isImapSource } from '../utils/forecastDashboardHelpers';

type Camera = ForecastCamera;
