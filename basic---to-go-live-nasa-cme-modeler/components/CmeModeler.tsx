...
// Corrected Paths: Use ../ to go up one directory from 'components'
...
const CmeModeler: React.FC = () => {
  // All state and logic from your original App.tsx is preserved here
  ...
  return (
    // This is now the root of the Modeler "page"
    <div className="relative w-full h-full text-neutral-300 overflow-hidden">
      ...
      {/* These buttons are part of the Modeler UI, positioned relative to its container */}
