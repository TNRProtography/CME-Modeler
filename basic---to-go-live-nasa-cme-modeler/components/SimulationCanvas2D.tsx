...
interface SimulationCanvas2DProps {
  ...
  onTimelineEnd: () => void;
  showExtraPlanets: boolean; // Will be ignored for Sun/Earth focus
  showLabels: boolean;
...
const SimulationCanvas2D: React.FC<SimulationCanvas2DProps> = (props) => {
    ...
    useEffect(() => {
        ...
        const cloudsGeo = new THREE.SphereGeometry(earthData.size * 1.01, 32, 32);
        ...
        const atmosphereGeo = new THREE.SphereGeometry(earthData.size * 1.15, 32, 32);
