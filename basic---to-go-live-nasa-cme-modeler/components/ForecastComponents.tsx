...
export const TipsSection: React.FC = () => (
    <CollapsibleSection title="Tips for Spotting the Aurora">
        <ul className="list-disc list-inside space-y-3 text-neutral-300 text-sm pl-2">
            ...
            <li>
                <strong>Find a Good Spot:</strong> Can't find a dark location with a clear southern view? Check out this list of spots curated specifically for the West Coast.
                <a 
