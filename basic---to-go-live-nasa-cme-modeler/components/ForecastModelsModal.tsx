...
const ForecastModelsModal: React.FC<ForecastModelsModalProps> = ({ isOpen, onClose, onMediaSelect }) => {
        ...
        <div className="overflow-y-auto p-5 styled-scrollbar pr-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <section className="space-y-4">
            ...
            <div className="space-y-4">
                <div 
                  onClick={() => onMediaSelect({ url: 'https://huxt-bucket.s3.eu-west-2.amazonaws.com/wsa_huxt_forecast_latest.png', type: 'image' })}
                ...
                <div 
                  onClick={() => onMediaSelect({ url: 'https://huxt-bucket.s3.eu-west-2.amazonaws.com/wsa_huxt_animation_latest.mp4', type: 'video' })}
                  className="block bg-neutral-900 p-2 rounded-lg hover:ring-2 ring-sky-400 transition-shadow cursor-pointer"
                >
          ...
          <section className="space-y-4">
            ...
            <div 
              onClick={() => enlilImageUrls.length > 0 && onMediaSelect({ url: enlilImageUrls[currentEnlilImageIndex], type: 'image' })}
