...
export const NOTIFICATION_CATEGORIES: NotificationCategory[] = [
  ...
  {
    id: 'shock-ff',
    ui: 'toggle', defaultOn: false, group: 'solar',
  ...
  // somebody made rather than something nobody noticed.
  {
    ...
    note: 'Sent once a flare has peaked. Turning off the M/X toggles does not turn this off - it has its own stored preference and no UI.',
  },
  {
    id: 'flare-peak',
    ui: 'hidden', defaultOn: true,
    ...
    note: 'Superseded by flare-event in the UI, but the worker still sends both, so a peak produces two notifications.',
  },
  {
